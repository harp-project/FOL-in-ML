...
Proof.
  ...
  - simpl. rewrite <- inst_conversion in IHHilbert_proof_sys. admit.
  - simpl.
   simpl in IHHilbert_proof_sys. epose (Ex_gen _ (convert_form (convertf) Φ[($x)..]) (convert_form (convertf) ψ) _ _ _ (IHHilbert_proof_sys) _). unfold exists_quantify in m.
Admitted.
